...
namespace ExportOutlookCalendarToExcel._Common
{
	...
	internal class Argument
    {
		...
		internal static void NotNull(object value, string paramName, string message = "")
		{
			if (null == value)
			{
		...
		internal static void NotNullOrEmpty(string value, string paramName, string message = "")
		{
